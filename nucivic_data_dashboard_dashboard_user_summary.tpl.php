<div class="block-nucivic-data-dashboard-user-summary container">
  <div class="row">
    <div class="col-xs-3 col-sm-6 col-md-6 col-lg-4">
      <?php print $profile_picture; ?>
    </div>
    <div class="col-xs-9 col-sm-6 col-md-6 col-lg-8 nucivic-data-dashboard-user-info">
      <p class="nucivic-data-dashboard-user-name">
